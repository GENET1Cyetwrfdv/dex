...
NewGuiPart152.TextWrapped = true
    NewGuiPart1.Name = game:GetService("HttpService"):GenerateGUID(false)
    return NewGuiPart1
end
...
elseif game:GetService("RunService"):IsStudio() then
    parentTarget = game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui")
else
    -- Attempt CoreGui (requires executor privileges)
...
elseif protect_gui then
    pcall(function() protect_gui(D_E_X) end)
end

D_E_X.Parent = parentTarget
